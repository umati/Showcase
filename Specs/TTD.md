...
In the following the umati showcase describes the additional information on top of the  OPC 40444 UA for Textile Testing Devices release canidate companion specification.

Please refer to the provided XML-NodeSets, UaModeler-project or the [TTD repos](https://github.com/umati/TTD) for exemplary implementation.
